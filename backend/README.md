...
## Project Structure
    ...
    ├── fleet_management_ap_43928  # Django project configurations
...
1. Clone this repo and `cd fleet_management_ap_43928`
...
2. Clone this repo and `cd fleet_management_ap_43928`
